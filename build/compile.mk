...
LDFLAGS   =  -s -w \
	-X github.com/astrokube/layout-kubebuilder-plugin/internal/info.Commit=$(COMMIT) \
	-X github.com/astrokube/layout-kubebuilder-plugin/internal/info.Version=$(VERSION) \
	-X github.com/astrokube/layout-kubebuilder-plugin/internal/info.BuildDate=$(BUILD_DATE) \
	-X github.com/astrokube/layout-kubebuilder-plugin/internal/info.Compiler=$(GOLANG_VERSION)
